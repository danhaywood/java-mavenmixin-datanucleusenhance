...
* (optionally), overrride the `danhaywood-mavenmixin-datanucleusenhance.log4jConfiguration` and other properties
...
[source,bash]
----
mvn -Dskip.danhaywood-mavenmixin-datanucleusenhance
----
